...
@media screen and (max-width: 1500px) {
  .error-message, .success-message {
    ...
    width: 300px; /* 상대적인 단위로 변경 */
    font-size: 21px; /* 상대적인 단위로 변경 */
    font-weight: bold;
    color: #484848;/* 상대적인 단위로 변경 */
    margin-top: 30px;
    margin-bottom: 25px;
    margin-left: 255px; /* 상대적인 단위로 변경 */
    padding: 15px; /* 상대적인 단위로 변경 */
    cursor: pointer;
    position: relative;
    display: inline-flex;
    align-items: center;
    ...
    .error-message {
    color: #FA5C87;
    margin-left: 270px; /* 상대적인 단위로 변경 */
    display: block;
    font-size: 16px; /* 상대적인 단위로 변경 */
    }
    .success-message {
    color: #00D26A;
